...
public class OptionalStreamTest {
    ...
    @Test
    public void whenManyUsersAndManyPhonesThenOnePhone() {
    ...
    @Test
    public void whenManyPhonesThenOnlyWithRegion() {
        PhoneNumber ph1 = new PhoneNumber("+7 123 345 61 91");
        PhoneNumber ph2 = new PhoneNumber("+7 123 345 61 92");
        PhoneNumber ph3 = new PhoneNumber("+7 123 345 61 93");
        PhoneNumber ph4 = new PhoneNumber("+1 123 345 61 91");
    ...
    @Test
    public void whenAbsentUserIdThenListEmpty() {
        User u1 = new User(1, List.of());
        User u2 = new User(2, List.of());
        User u3 = new User(3, List.of());
        User u4 = new User(3, List.of());
    ...
    @Test
    public void whenAbsentPhonesThenListEmpty() {
        User u1 = new User(1, List.of());
        User u2 = new User(2, List.of());
        User u3 = new User(3, List.of());
        User u4 = new User(3, List.of());
