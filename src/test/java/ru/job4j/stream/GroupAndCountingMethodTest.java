...
import static ru.job4j.stream.GroupAndCountingMethod.*;

public class GroupAndCountingMethodTest {
    ...
    public void test() {
        ...
        assertEquals(expect, GroupAndCountingMethod.groupAndCount(List.of(w1, w2, w3, w4, w5, w6)));
    }
