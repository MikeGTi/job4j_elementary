...
public class Task44getRoundNumberTest {
    ...
    public void when553Then550() {
        ...
        Task44getRoundNumber.getRoundNumber(553);
    ...
    public void when57Then60() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task44getRoundNumber.getRoundNumber(57);
    ...
    public void when5501Then5500() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task44getRoundNumber.getRoundNumber(5501);
    ...
    public void when53530Then53530() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task44getRoundNumber.getRoundNumber(53530);
    ...
    public void when4Then0() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task44getRoundNumber.getRoundNumber(4);
    ...
    public void when9Then10() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task44getRoundNumber.getRoundNumber(9);
    ...
    public void when5Then10() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task44getRoundNumber.getRoundNumber(5);
        String expected = "10" + ln;
        assertThat(out.toString(), is(expected));
    }
}