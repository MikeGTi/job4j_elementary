...
public class Task48changeNumThreeNumbersTest {
        ...
        public void when2And2dot5And3Then5dot0() {
            ...
            Task48changeNumThreeNumbers.changeNum(2, 2.5, 3);
        ...
        public void when4And1dot5And5Then6dot0() {
            ByteArrayOutputStream out = new ByteArrayOutputStream();
            System.setOut(new PrintStream(out));
            Task48changeNumThreeNumbers.changeNum(4, 1.5, 5);
        ...
        public void when3And3dot5And4Then7() {
            ByteArrayOutputStream out = new ByteArrayOutputStream();
            System.setOut(new PrintStream(out));
            Task48changeNumThreeNumbers.changeNum(3, 3.5, 4);
        ...
        public void when1And4dot5And5Then6() {
            ByteArrayOutputStream out = new ByteArrayOutputStream();
            System.setOut(new PrintStream(out));
            Task48changeNumThreeNumbers.changeNum(1, 4.5, 5);
