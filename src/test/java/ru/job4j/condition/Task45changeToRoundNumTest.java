...
public class Task45changeToRoundNumTest {
    ...
    public void when23Then20() {
        ...
        Task45changeToRoundNum.changeToRoundNum(23);
    ...
    public void when339Then330() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task45changeToRoundNum.changeToRoundNum(339);
    ...
    public void when272Then280() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task45changeToRoundNum.changeToRoundNum(272);
    ...
    public void when20Then20() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task45changeToRoundNum.changeToRoundNum(20);
