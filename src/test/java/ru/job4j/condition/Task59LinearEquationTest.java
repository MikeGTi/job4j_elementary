...
public class Task59LinearEquationTest {
    ...
    public void when2And6ThenMinus3dot0() {
        ...
        Task59linearEquation.getLinearEquation(2, 6);
    ...
    public void when4And6ThenMinus1dot5() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task59linearEquation.getLinearEquation(4, 6);
    ...
    public void when2AndMinus10Then5dot0() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task59linearEquation.getLinearEquation(2, -10);
    ...
    public void when0And5ThenNo() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task59linearEquation.getLinearEquation(0, 5);
    ...
    public void when0And0ThenInfinity() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task59linearEquation.getLinearEquation(0, 0);
    ...
    public void when8And0ThenNo() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task59linearEquation.getLinearEquation(8, 0);
        String expected = "Нет решения" + ln;
        assertThat(out.toString(), is(expected));
    }
}