...
public class Task32NumCompareTest {
    ...
    public void when1And2Then1221() {
        ...
        Task32NumCompare.numCompare(1, 2);
    ...
    public void when2And1Then1221() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task32NumCompare.numCompare(2, 1);
        StringJoiner expected = new StringJoiner(
                System.lineSeparator(), "", System.lineSeparator())
                .add("1 2").add("2 1");
        assertThat(out.toString(), is(expected.toString()));
    ...
    public void when1And0Then0110() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task32NumCompare.numCompare(1, 0);
        StringJoiner expected = new StringJoiner(
                System.lineSeparator(), "", System.lineSeparator())
                .add("0 1").add("1 0");
        assertThat(out.toString(), is(expected.toString()));
    ...
    public void when0AndMinus1ThenMinus100Minus1() {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        System.setOut(new PrintStream(out));
        Task32NumCompare.numCompare(0, -1);
        StringJoiner expected = new StringJoiner(
                System.lineSeparator(), "", System.lineSeparator())
                .add("-1 0").add("0 -1");
        assertThat(out.toString(), is(expected.toString()));
